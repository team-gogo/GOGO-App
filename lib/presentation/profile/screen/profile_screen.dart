          ...
          if(state is ProfileLoadingState) {
            return LoadingPage();
                ...
                for (int i = 0; i < state.searchStageResponse.count; i++) {
                  ...
                  if (state.searchStageResponse.stages[i].status == StageStatus.CONFIRMED) {
                    confirmedStages.add(state.searchStageResponse.stages[i]);
                  }
                  if (state.searchStageResponse.stages[i].status == StageStatus.RECRUITING) {
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        ProfileCardComponent(
                          ...
                          male: state.userInfoResponse.sex == Sex.MALE ? "남자" : "여자",
                        ),
                        SizedBox(
                          height: 40,
                        ),
